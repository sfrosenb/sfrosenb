...
You can use the [editor on GitHub](https://github.com/sfrosenb/sfrosenb/edit/main/README.md) to maintain and preview the content for your website in Markdown files.
...
[Link](url) and ![Image](headshot_longhair_friendly_best_pic_cropped.png)
```
